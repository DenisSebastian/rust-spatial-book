...
### Preguntas clave
- ¿Estoy copiando datos innecesadamente? (Clonando strings o vectores grandes).
...
Si bien Rust ofrece herramientas poderosas para el paralelismo como `rayon`, este tema es tan vasto e importante para el análisis espacial que lo trataremos en profundidad en @sec-optH3, donde construiremos un sistema completo de optimización espacial con indexación H3.

## Caso Práctico Completo

El caso completo de optimización espacial con indexación H3 se encuentra en @sec-optH3, donde construiremos un sistema completo de búsqueda de POIs que mejora el rendimiento en más de 4,600x.
