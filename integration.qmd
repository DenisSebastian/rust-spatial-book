...
2.  **extendr-api**: Una crate de Rust que proporciona tipos seguros para interactuar con objetos de R. Por ejemplo, convierte un `NumericVector` de R en algo que Rust puede iterar.
...
rextendr::rust_sitrep() # Comprueba que tu entorno de Rust está listo
```
